...
public class App {
    ...
    public App() {
        ...
        frame.setPreferredSize(new Dimension(1000,
                600
        ));
            ...
            if(eventPanel.dir.getText() != "No File Location Selected") {
                ...
                if (writeValues) {
                    try {
                        ...
                        for (int i = 0; i < eventPanel.matchTable.getRowCount(); i++) {
                            outputWriter.write(((String) eventPanel.matchTable.getValueAt(i, 0)) + "," +
                                    ((String) eventPanel.matchTable.getValueAt(i, 1)) + "," +
                                    ((String) eventPanel.matchTable.getValueAt(i, 2)) + "," +
                                    ((String) eventPanel.matchTable.getValueAt(i, 3)) + "," +
                                    ((String) eventPanel.matchTable.getValueAt(i, 4)));
                            if(i != eventPanel.teamTable.getRowCount() - 1) {
                                outputWriter.newLine();
                            }
                        }
